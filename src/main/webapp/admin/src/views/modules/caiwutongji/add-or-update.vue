<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="当月收入" prop="dangyueshouru">
          <el-input v-model="ruleForm.dangyueshouru" 
              placeholder="当月收入" clearable  :readonly="ro.dangyueshouru"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="当月收入" prop="dangyueshouru">
              <el-input v-model="ruleForm.dangyueshouru" 
                placeholder="当月收入" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="当月支出" prop="dangyuezhichu">
          <el-input v-model="ruleForm.dangyuezhichu" 
              placeholder="当月支出" clearable  :readonly="ro.dangyuezhichu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="当月支出" prop="dangyuezhichu">
              <el-input v-model="ruleForm.dangyuezhichu" 
                placeholder="当月支出" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="纯利润" prop="chunlirun">
            <el-input v-model="chunlirun"
                placeholder="纯利润" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.chunlirun" label="纯利润" prop="chunlirun">
              <el-input v-model="ruleForm.chunlirun" 
                placeholder="纯利润" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
...
export default {
  ...
  computed: {
    chunlirun: {
      get: function () {
        return 0+parseFloat(this.ruleForm.dangyueshouru==""?0:this.ruleForm.dangyueshouru)-parseFloat(this.ruleForm.dangyuezhichu==""?0:this.ruleForm.dangyuezhichu) || 0
      }
    },
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `caiwutongji/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.caiwutongjiCrossAddOrUpdateFlag = false;
						 this.parent.search();
