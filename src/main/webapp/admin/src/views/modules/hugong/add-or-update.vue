<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.hugongzhaopian" label="护工照片" prop="hugongzhaopian">
          <file-upload
          tip="点击上传护工照片"
          action="file/upload"
          :limit="3"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.hugongzhaopian" label="护工照片" prop="hugongzhaopian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.hugongzhaopian.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="护工电话" prop="hugongdianhua">
          <el-input v-model="ruleForm.hugongdianhua" 
              placeholder="护工电话" clearable  :readonly="ro.hugongdianhua"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="护工电话" prop="hugongdianhua">
              <el-input v-model="ruleForm.hugongdianhua" 
                placeholder="护工电话" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="护理级别" prop="hulijibie">
        ...
        <div v-else>
          <el-form-item class="input" label="护理级别" prop="hulijibie">
