<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="底薪" prop="dixin">
          <el-input v-model="ruleForm.dixin" 
              placeholder="底薪" clearable  :readonly="ro.dixin"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="底薪" prop="dixin">
              <el-input v-model="ruleForm.dixin" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="扣请假" prop="kouqingjia">
          <el-input v-model="ruleForm.kouqingjia" 
              placeholder="扣请假" clearable  :readonly="ro.kouqingjia"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="扣请假" prop="kouqingjia">
              <el-input v-model="ruleForm.kouqingjia" 
                placeholder="扣请假" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="扣五险一金" prop="kouwuxianyijin">
          <el-input v-model="ruleForm.kouwuxianyijin" 
              placeholder="扣五险一金" clearable  :readonly="ro.kouwuxianyijin"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="扣五险一金" prop="kouwuxianyijin">
              <el-input v-model="ruleForm.kouwuxianyijin" 
                placeholder="扣五险一金" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="其它奖励" prop="qitajiangli">
          <el-input v-model="ruleForm.qitajiangli" 
              placeholder="其它奖励" clearable  :readonly="ro.qitajiangli"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="其它奖励" prop="qitajiangli">
              <el-input v-model="ruleForm.qitajiangli" 
                placeholder="其它奖励" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="工资备注" prop="gongzibeizhu">
          <el-input v-model="ruleForm.gongzibeizhu" 
              placeholder="工资备注" clearable  :readonly="ro.gongzibeizhu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="工资备注" prop="gongzibeizhu">
              <el-input v-model="ruleForm.gongzibeizhu" 
                placeholder="工资备注" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  data() {
	...
	gongzibeizhu : false,
      ...
      rules: {
          ...
          kouqingjia: [
                { required: true, message: '扣请假不能为空', trigger: 'blur' },
                { validator: validateIntNumber, trigger: 'blur' },
          ],
          kouwuxianyijin: [
                { required: true, message: '扣五险一金不能为空', trigger: 'blur' },
                { validator: validateIntNumber, trigger: 'blur' },
          ],
          qitakoukuan: [
          ...
          qitajiangli: [
                { required: true, message: '其它奖励不能为空', trigger: 'blur' },
                { validator: validateIntNumber, trigger: 'blur' },
          ],
          shifagongzi: [
                { validator: validateIntNumber, trigger: 'blur' },
  ...
  computed: {
    shifagongzi: {
      get: function () {
        return 0+parseFloat(this.ruleForm.dixin==""?0:this.ruleForm.dixin)+parseFloat(this.ruleForm.jixiao==""?0:this.ruleForm.jixiao)+parseFloat(this.ruleForm.jiabangongzi==""?0:this.ruleForm.jiabangongzi)-parseFloat(this.ruleForm.kouqingjia==""?0:this.ruleForm.kouqingjia)-parseFloat(this.ruleForm.kouwuxianyijin==""?0:this.ruleForm.kouwuxianyijin)-parseFloat(this.ruleForm.qitakoukuan==""?0:this.ruleForm.qitakoukuan)+parseFloat(this.ruleForm.qitajiangli==""?0:this.ruleForm.qitajiangli) || 0
      }
    },
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jiabangongzi = true;
          ...
          if(o=='kouqingjia'){
            this.ruleForm.kouqingjia = obj[o];
	    this.ro.kouqingjia = true;
            continue;
          }
          if(o=='kouwuxianyijin'){
            this.ruleForm.kouwuxianyijin = obj[o];
	    this.ro.kouwuxianyijin = true;
            continue;
          }
          if(o=='qitakoukuan'){
	    ...
	    this.ro.qitakoukuan = true;
          ...
          if(o=='qitajiangli'){
            this.ruleForm.qitajiangli = obj[o];
	    this.ro.qitajiangli = true;
            continue;
          }
          if(o=='shifagongzi'){
