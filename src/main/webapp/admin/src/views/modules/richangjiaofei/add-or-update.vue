<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="缴费标题" prop="jiaofeibiaoti">
          <el-input v-model="ruleForm.jiaofeibiaoti" 
              placeholder="缴费标题" clearable  :readonly="ro.jiaofeibiaoti"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="缴费标题" prop="jiaofeibiaoti">
              <el-input v-model="ruleForm.jiaofeibiaoti" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="缴费内容" prop="jiaofeineirong">
          <el-input v-model="ruleForm.jiaofeineirong" 
              placeholder="缴费内容" clearable  :readonly="ro.jiaofeineirong"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="缴费内容" prop="jiaofeineirong">
              <el-input v-model="ruleForm.jiaofeineirong" 
                placeholder="缴费内容" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `richangjiaofei/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.richangjiaofeiCrossAddOrUpdateFlag = false;
						 this.parent.search();
