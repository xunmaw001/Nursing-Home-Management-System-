    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="退房备注" prop="tuifangbeizhu">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.tuifangbeizhu" label="退房备注" prop="tuifangbeizhu">
                    <span>{{ruleForm.tuifangbeizhu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
