<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="外出地点" prop="waichudidian">
          <el-input v-model="ruleForm.waichudidian" 
              placeholder="外出地点" clearable  :readonly="ro.waichudidian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="外出地点" prop="waichudidian">
              <el-input v-model="ruleForm.waichudidian" 
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="外出时间" prop="waichushijian">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.waichushijian" label="外出时间" prop="waichushijian">
              <el-input v-model="ruleForm.waichushijian" 
                placeholder="外出时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
