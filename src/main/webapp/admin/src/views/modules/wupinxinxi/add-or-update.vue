    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="物品说明" prop="wupinshuoming">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="物品说明"
                  v-model="ruleForm.wupinshuoming" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.wupinshuoming" label="物品说明" prop="wupinshuoming">
                    <span>{{ruleForm.wupinshuoming}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xinghao = true;
          ...
          if(o=='wupinshuoming'){
            this.ruleForm.wupinshuoming = obj[o];
	    this.ro.wupinshuoming = true;
            continue;
          }
        }
      }
